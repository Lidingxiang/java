package com.dingxiang.hellodriver; /**
...
public class HelloWorldService {
  ...
  public interface AsyncIface {
    ...
    public void getRandom(AsyncMethodCallback resultHandler) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_getRandom() throws TException
    {
      getRandom_args args = new getRandom_args();
      sendBase("getRandom", args);
    }

    public String recv_getRandom() throws TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getRandom_call extends org.apache.thrift.async.TAsyncMethodCall {
      public getRandom_call(AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getRandom<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getRandom_args> {
      ...
      public getRandom_result getResult(I iface, getRandom_args args) throws TException {
        getRandom_result result = new getRandom_result();
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getRandom<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getRandom_args, String> {
      ...
      public void start(I iface, getRandom_args args, AsyncMethodCallback<String> resultHandler) throws TException {
  ...
  public static class getRandom_args implements org.apache.thrift.TBase<getRandom_args, getRandom_args._Fields>, java.io.Serializable, Cloneable, Comparable<getRandom_args>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getRandom_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getRandom_argsTupleSchemeFactory());
    }
...
;
    ...
    private static class getRandom_argsStandardSchemeFactory implements SchemeFactory {
      public getRandom_argsStandardScheme getScheme() {
        return new getRandom_argsStandardScheme();
      }
    }

    private static class getRandom_argsStandardScheme extends StandardScheme<getRandom_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, getRandom_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getRandom_args struct) throws TException {
        struct.validate();
    ...
    private static class getRandom_argsTupleSchemeFactory implements SchemeFactory {
      public getRandom_argsTupleScheme getScheme() {
        return new getRandom_argsTupleScheme();
      }
    }

    private static class getRandom_argsTupleScheme extends TupleScheme<getRandom_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getRandom_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
      }

      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getRandom_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
      }
    }
  ...
  public static class getRandom_result implements org.apache.thrift.TBase<getRandom_result, getRandom_result._Fields>, java.io.Serializable, Cloneable, Comparable<getRandom_result>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getRandom_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getRandom_resultTupleSchemeFactory());
    }
    ...
    private static class getRandom_resultStandardSchemeFactory implements SchemeFactory {
      public getRandom_resultStandardScheme getScheme() {
        return new getRandom_resultStandardScheme();
      }
    }

    private static class getRandom_resultStandardScheme extends StandardScheme<getRandom_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, getRandom_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getRandom_result struct) throws TException {
        struct.validate();
    ...
    private static class getRandom_resultTupleSchemeFactory implements SchemeFactory {
      public getRandom_resultTupleScheme getScheme() {
        return new getRandom_resultTupleScheme();
      }
    }

    private static class getRandom_resultTupleScheme extends TupleScheme<getRandom_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getRandom_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getRandom_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readString();
